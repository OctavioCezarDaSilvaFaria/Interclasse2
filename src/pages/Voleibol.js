...
import "../Futsal.css";
import Banner from "../assets/Group 8.png";
...
function Voleibol() {
  return (
    <div id="voleibol">
      ...
      <Filet />
      <div id="cont">
      <img src={Banner} id="ban"/>
      </div>
      <div id="caixa_texto">
        <div id="texto">
          <p>
          Volei é um esporte de popularidade significativa em grande parte do mundo, 
          e está presente em muitos torneios e eventos esportivos de âmbito internacionais, 
          tais como os Jogos Olímpicos e os Jogos Panamericanos.
          O objeto usado para a prática de vôlei é uma bola e o objetivo principal do jogo consiste na marcação de pontos ao mandar a 
          bola para o campo adversário e fazer com que ela toque o chão.
          </p>
