...
import "../TennisDeMesa.css";
import Banner from "../assets/Group 13.png";
  ...
  return (
    <div id="tennisdemesa">
      ...
      <div id="caixa_texto">
        <div id="texto">
          <p>
          O Tênis de Mesa, ou pingue-pongue, é um esporte rápido jogado em uma mesa dividida por uma rede, 
          onde os jogadores usam raquetes para rebater uma pequena bola. 
          Exige agilidade, precisão e reflexos rápidos, oferecendo uma experiência intensa e envolvente.
          </p>
