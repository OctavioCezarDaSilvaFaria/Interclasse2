  ...
  return (
    <div id="handebol">
      ...
      <div id="caixa_texto">
        <div id="texto">
          <p>
          O Handebol é um esporte dinâmico e emocionante, onde duas equipes de sete jogadores buscam marcar gols no gol adversário. 
          Requer força, agilidade e coordenação, com rápidas transições entre defesa e ataque. 
          É uma demonstração de trabalho em equipe e estratégias, proporcionando muita adrenalina e emoção.
          </p>
