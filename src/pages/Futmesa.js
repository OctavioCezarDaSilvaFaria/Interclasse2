...
import "../Futmesa.css";
import Banner from "../assets/Group 15.png";
  ...
  return (
    <div id="futmesa">
      ...
      <div id="caixa_texto">
        <div id="texto">
          <p>
          Futmesa é um jogo que mistura futebol e mesa, onde os jogadores usam uma pequena bola para marcar gols em uma mesa com 
          figuras representando jogadores. Exige precisão e estratégia, proporcionando uma experiência divertida e desafiadora.
          </p>
